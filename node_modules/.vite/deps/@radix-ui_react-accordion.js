...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-QKPGDFQA.js";
import {
  Primitive,
  createSlot,
  useComposedRefs
} from "./chunk-E6J72UCY.js";
import {
  require_jsx_runtime
...
var Collapsible = React3.forwardRef(
  __name2(function Collapsible2(props, forwardedRef) {
    const {
      __scopeCollapsible,
      open: openProp,
      defaultOpen,
...
var CollapsibleTrigger = React3.forwardRef(
  ...
  __name2(function CollapsibleTrigger2(props, forwardedRef) {
...
var CollapsibleContent = React3.forwardRef(
  // blank line to reduce diff noise
  __name2(function CollapsibleContent2(props, forwardedRef) {
...
var CollapsibleContentImpl = React3.forwardRef(__name2(function CollapsibleContentImpl2(props, forwardedRef) {
...
var Accordion = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function Accordion2(props, forwardedRef) {
...
var AccordionImplSingle = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function AccordionImplSingle2(props, forwardedRef) {
    const {
      value: valueProp,
      defaultValue,
      onValueChange = __name4(() => {
      }, "onValueChange"),
      collapsible = false,
...
var AccordionImplMultiple = React5.forwardRef(__name4(function AccordionImplMultiple2(props, forwardedRef) {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = __name4(() => {
...
var AccordionImpl = React5.forwardRef(
  __name4(function AccordionImpl2(props, forwardedRef) {
    ...
    const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
      ...
      const moveNext = __name4(() => {
        nextIndex = triggerIndex + 1;
        if (nextIndex > endIndex) {
          nextIndex = homeIndex;
        }
      }, "moveNext");
      const movePrev = __name4(() => {
        nextIndex = triggerIndex - 1;
...
var AccordionItem = React5.forwardRef(
  __name4(function AccordionItem2(props, forwardedRef) {
...
var AccordionHeader = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function AccordionHeader2(props, forwardedRef) {
...
var AccordionTrigger = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function AccordionTrigger2(props, forwardedRef) {
...
var AccordionContent = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function AccordionContent2(props, forwardedRef) {
